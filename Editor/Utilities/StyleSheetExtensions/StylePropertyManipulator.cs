...
#else
                        list.Insert(++currentOffset, new StyleValueHandle(-1, StyleValueType.FunctionSeparator));
#endif
...
#else
            styleSheet.AddValueHandle(styleProperty, -1, StyleValueType.FunctionSeparator);
#endif
        }
