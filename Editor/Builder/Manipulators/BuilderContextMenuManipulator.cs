...
{
    internal class BuilderContextMenuManipulator
    {
        ...
        public BuilderContextMenuManipulator(Builder builder, BuilderSelection selection)
        {
            m_Builder = builder;
        ...
        public void BuildElementContextualMenu(ContextualMenuPopulateEvent evt, VisualElement target)
        {
            ...
            if (isValidTarget)
            {
                ...
                // If valid item, stop from building menu on parent container.
            ...
            evt.menu.AppendAction(
                "Paste",
                a => m_Builder.commandHandler.Paste(),
