    ...
    internal class BuilderStyleSheets : BuilderExplorer
    {
                  ...
                  kToolbarPath)
        {
            ...
            if (m_TooltipPreview != null)
            {
                ...
                foreach (var child in helpTooltipContainer.Children()
                    .Where(x => x.ClassListContains(BuilderConstants.CodeClassName)))
                    child.AddToClassList(BuilderConstants.CodeFontClassName);
